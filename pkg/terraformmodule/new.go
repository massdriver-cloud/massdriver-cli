...
//
//go:embed templates/* templates/terraform-module/.pre-commit-config.yaml templates/terraform-module/.gitignore templates/terraform-module/_providers.tf templates/terraform-module/_variables.tf
